...
-------------------------------------------------------------------------------
  Filename:   test_detector_pcpich_short.py
  Author(s):  pdm
-------------------------------------------------------------------------------
File Description (User Field)
----------------------------

Test the channel filter and correlator using the short PCPICH filters (as used for the reference calibration)
...
def main(address, plot_results = False) :
    ...
    if (freq_Hz == 1930000000) :
        phy.set_vctcxo(1920)    # sig. gen.
    ...
    elif (freq_Hz == 2162200000) :    
        phy.set_vctcxo(1920)    # 10.10.7.100 tuned to 2162200000
